...
/**
 * Clase Admin que representa un administrador
 * Extiende la clase Usuario y agrega funcionalidades para administrar a los usuarios
 */
public class Admin extends Usuario {
    ...
    /**
     * Consulta la lista de usuarios registrados en el sistema y los imprime
    ...
    /**
     * Crea un nuevo usuario en el sistema con su especifico rol
     *
     * @param nombre      Nombre
     * @param correo      Correo electrónico
     * @param edad        Edad
